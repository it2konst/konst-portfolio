    ...
    cards: [
        {
            "id": 1,
            "title": "Lingua Boost",
            "desc": "Я изменил значения в функции polygon() так, чтобы обрезать верхние углы. Первые две координаты (0 10% и 10% 0) определяют обрезку верхнего левого угла, а последние две (0 100% и 10% 100%) - верхнего правого угла. Остальные координаты остаются такими же, как в вашем примере.",
            "descLang": "ru-Ru",
